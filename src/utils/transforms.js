...
export const controllaSlugFromUrl = url =>
  url
...
export const controllaLogoUrl = pkg =>
  pkg.controlla.logo || pkg.controlla.logoUrl || false;

export const controllaDonationText = pkg =>
  (pkg.controlla.donation && pkg.controlla.donation.text) || "Visit:";
...
export const controllaDonationUrl = pkg => {
  const defaultDonationAmount =
    pkg.controlla.donation && pkg.controlla.donation.amount;
